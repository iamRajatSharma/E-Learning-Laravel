                        ...
                        <div class="item">
                            <div class="cours-bx">
                                <div class="action-box">
                                    ...
                                    <a href="course_details/{{ $course->id }}" class="btn">Read More</a>
                                </div>
                                <div class="info-bx text-center">
                                    <h5><a href="course_details/{{ $course->id }}">{{ $course->title }}</a></h5>
                                ...
                                <div class="cours-more-info">
                                    ...
                                    <div class="price">
                                        ...
                                        <h5><i class="fa fa-inr mr-2">{{ $course->dis }}</i></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="join-content-bx text-white">
                            ...
                            <a href="courses?name=all" class="btn button-md">Join Now</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 m-b30">
                                <div class="feature-container">
                                    <div class="feature-md text-white m-b20">
                                        <a href="courses?name=all" class="icon-cell"><img
